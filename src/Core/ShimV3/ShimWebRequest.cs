...
namespace NuGet
{
    public class ShimWebRequest : IODataRequestMessage
    {

        public HttpWebRequest WebRequest { get; private set; }

        public ShimWebRequest(IODataRequestMessage message)
        {
        ...
        public ShimWebRequest(DataServiceClientRequestMessageArgs args)
        {
