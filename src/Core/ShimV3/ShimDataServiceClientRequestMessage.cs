...
namespace NuGet
{
    public class ShimDataServiceClientRequestMessage : DataServiceClientRequestMessage
    {
            ...
            : base(args.Method)
        {
            ...
            ShimWebRequest = new ShimWebRequest(args);
        }
        ...
        public override IODataResponseMessage EndGetResponse(IAsyncResult asyncResult)
        {
            ...
            return new ShimWebResponse(response as HttpWebResponse);
        }
        ...
        {
            var response = ShimWebRequest.WebRequest.GetResponse();

            ShimWebResponse shimResponse = new ShimWebResponse(response as HttpWebResponse);
