...
namespace NuGet
{
    public class LocalPackageRepository2 : FileSystemRepository
    {
        ...
        public LocalPackageRepository2(string physicalPath)
            : this(physicalPath, enableCaching: true)
        {
        }

        public LocalPackageRepository2(string physicalPath, bool enableCaching)
        ...
        public LocalPackageRepository2(IPackagePathResolver pathResolver, IFileSystem fileSystem)
            : this(pathResolver, fileSystem, enableCaching: true)
        {
        }

        public LocalPackageRepository2(IPackagePathResolver pathResolver, IFileSystem fileSystem, bool enableCaching)
        ...
        public override IQueryable<IPackage> GetPackages(string packageId)
        {
            ...
            return FindPackagesById(OpenPackage, packageId).AsQueryable();
        }
