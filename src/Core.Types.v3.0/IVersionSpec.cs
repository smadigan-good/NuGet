...
namespace NuGet
{
    ...
    public interface IVersionSpec
    {
        ...
        bool Satisfies(INuGetVersion version);
        ...
        /// <returns>True if the given version meets the version requirements.</returns>
        bool Satisfies(INuGetVersion version, VersionComparison versionComparison);
        ...
        /// <returns>True if the given version meets the version requirements.</returns>
        bool Satisfies(INuGetVersion version, IVersionComparer comparer);
