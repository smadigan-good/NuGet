...
namespace NuGet
{
    public sealed class GalleryV2MemoryCache : IDisposable
    {
        private static readonly Lazy<GalleryV2MemoryCache> _instance = new Lazy<GalleryV2MemoryCache>(() => new GalleryV2MemoryCache());
